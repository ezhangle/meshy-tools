...
void format_data( face *faces, vertex *vertices, vertex *std_verts, vector *std_norms
			, face *std_faces, long int numverts, long int numfaces);

void read_normal_file( FILE * normal_file, vector * vert_normals, long int numverts );

void calc_face_normals( face * faces, fc_normal *face_normals, vertex * vertices
						, long int numfaces);
...
void calc_vertex_normals( vertex * verts, vector *vert_normals, vert_extra *vert_aug, face * faces
		, fc_normal *face_normals, long int numfaces, long int numverts );
